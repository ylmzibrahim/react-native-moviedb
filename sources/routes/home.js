...
function Home({ navigation }) {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                ...
                <FlatList
                    ...
                    data={nowPlaying}
                    keyExtractor={item => item.id.toString()}
                    renderItem={({item, index}) => <RenderItemMovies item={item} />}
                />
    ...
    function RenderItemMovies({item}) {
        ...
        return (
            <ImageBackground source={{uri: 'https://image.tmdb.org/t/p/w500' + item.poster_path}} style={styles.postView} resizeMode={'cover'}>
